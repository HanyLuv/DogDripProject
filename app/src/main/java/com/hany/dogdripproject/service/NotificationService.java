...
import com.hany.dogdripproject.service.alarm.AlarmData;
import com.hany.dogdripproject.service.alarm.AlarmHelper;
import com.hany.dogdripproject.service.notification.NotificationData;
import com.hany.dogdripproject.service.notification.NotificationHelper;
...
public class NotificationService extends IntentService {
    ...
    public static final void createAlarm(Context context, AlarmData data){
        if(context != null && data != null){
            Intent intent = new Intent(context, NotificationService.class);
            intent.setAction(ACTION_CREAE_ALARM);
            intent.putExtra(AlarmHelper.KEY_ALARM_PARCELABLE, data);
            context.startService(intent);
        }
    }
}
